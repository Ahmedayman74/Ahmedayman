...
let contactBoxes = document.querySelectorAll(".contact .container .boxes .box")
...
let projectImg = document.querySelectorAll(".img-box img")
...
projectImg.forEach((img) => {
    img.addEventListener("click" , (e) => {
        ...
        let xmarkcircle = document.createElement("div")
        xmarkcircle.className = "circle-btn"
        popupbox.appendChild(xmarkcircle)
        let xmarkicon = document.createElement("i")
        xmarkicon.className = "fa-solid fa-xmark"
        xmarkcircle.appendChild(xmarkicon)
